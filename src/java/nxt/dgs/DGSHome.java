...
public final class DGSHome {
    ...
    public void listGoods(ChildTransactionImpl transaction, Attachment.DigitalGoodsListing attachment) {
    ...
    public void purchase(ChildTransaction transaction, Attachment.DigitalGoodsPurchase attachment) {
    ...
    public void deliver(ChildTransaction transaction, Attachment.DigitalGoodsDelivery attachment) {
