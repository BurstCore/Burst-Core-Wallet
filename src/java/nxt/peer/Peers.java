...
public final class Peers {
    ...
    public static void init() {
        ...
        //
        ThreadPool.scheduleThread("PeerUnBlacklistingThread", peerUnBlacklistingThread, 60);
        ThreadPool.scheduleThread("PeerConnectingThread", peerConnectingThread, 60);
        if (getMorePeers) {
            ThreadPool.scheduleThread("GetMorePeersThread", getMorePeersThread, 10*60);
        }
        if (savePeers) {
            ThreadPool.scheduleThread("UpdatePeerDbThread", updatePeerDbThread, 60*60);
        }
    }
