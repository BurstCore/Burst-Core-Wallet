    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(fileName))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if ("asset transfer".equals(event) && Constants.CREATOR_ID == Convert.parseUnsignedLong(accountId)) {
                    String assetId = valueMap.get("asset");
            ...
            for (Map.Entry<String,Map<String,Long>> mapEntry : totals.entrySet()) {
                ...
                for (Map.Entry<String,Map<String,Long>> assetMapEntry : accountAssetMap.entrySet()) {
                    ...
                    if (assetBalance != totalAssetDelta && (Constants.CREATOR_ID != Convert.parseUnsignedLong(accountId) || assetBalance != 0)) {
