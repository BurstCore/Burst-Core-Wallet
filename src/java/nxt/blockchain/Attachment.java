...
public interface Attachment extends Appendix {
    ...
    final class MonetarySystemCurrencyIssuance extends AbstractAttachment {
        ...
        public MonetarySystemCurrencyIssuance(ByteBuffer buffer) throws NxtException.NotValidException {
            super(buffer);
    ...
    final class ShufflingRecipients extends AbstractShufflingAttachment {
        ...
        public ShufflingRecipients(ByteBuffer buffer) throws NxtException.NotValidException {
            super(buffer);
    ...
    final class ShufflingCancellation extends AbstractShufflingAttachment {
        ...
        public ShufflingCancellation(ByteBuffer buffer) throws NxtException.NotValidException {
            super(buffer);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new NxtException.NotValidException("Invalid data count " + count);
    ...
    final class TaggedDataExtend extends TaggedDataAttachment {
        ...
        public byte[] getHash() {
            ...
            if (hash == null) {
                ...
                TaggedDataUpload taggedDataUpload = (TaggedDataUpload)Nxt.getBlockchain().getTransaction(ChildChain.NXT, taggedDataId).getAttachment();
