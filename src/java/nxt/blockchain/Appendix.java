...
public interface Appendix {
    ...
    class Message extends AbstractAppendix {
        ...
        public Message(ByteBuffer buffer) throws NxtException.NotValidException {
            super(buffer);
    ...
    class EncryptedMessage extends AbstractEncryptedMessage {
        ...
        public EncryptedMessage(ByteBuffer buffer) throws NxtException.NotValidException {
            super(buffer);
        }
    ...
    class EncryptToSelfMessage extends AbstractEncryptedMessage {
        ...
        public EncryptToSelfMessage(ByteBuffer buffer) throws NxtException.NotValidException {
            super(buffer);
        }
