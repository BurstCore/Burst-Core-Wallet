...
public final class PrunableMessageHome {
    ...
    void add(TransactionImpl transaction, Appendix.PrunablePlainMessage appendix) {
        add(transaction, appendix, Nxt.getBlockchain().getLastBlockTimestamp(), Nxt.getBlockchain().getHeight());
    }

    void add(TransactionImpl transaction, Appendix.PrunablePlainMessage appendix, int blockTimestamp, int height) {
    ...
    void add(TransactionImpl transaction, Appendix.PrunableEncryptedMessage appendix) {
        add(transaction, appendix, Nxt.getBlockchain().getLastBlockTimestamp(), Nxt.getBlockchain().getHeight());
    }

    void add(TransactionImpl transaction, Appendix.PrunableEncryptedMessage appendix, int blockTimestamp, int height) {
