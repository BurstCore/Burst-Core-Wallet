...
public abstract class MonetarySystem extends ChildTransactionType {
    ...
    public static final TransactionType CURRENCY_ISSUANCE = new MonetarySystem() {
        ...
        @Override
        public Attachment.MonetarySystemCurrencyIssuance parseAttachment(ByteBuffer buffer) throws NxtException.NotValidException {
            return new Attachment.MonetarySystemCurrencyIssuance(buffer);
        }

        @Override
        public Attachment.MonetarySystemCurrencyIssuance parseAttachment(JSONObject attachmentData) throws NxtException.NotValidException {
    ...
    public static final TransactionType RESERVE_INCREASE = new MonetarySystem() {
        ...
        @Override
        public Attachment.MonetarySystemReserveIncrease parseAttachment(ByteBuffer buffer) throws NxtException.NotValidException {
            return new Attachment.MonetarySystemReserveIncrease(buffer);
        }

        @Override
        public Attachment.MonetarySystemReserveIncrease parseAttachment(JSONObject attachmentData) throws NxtException.NotValidException {
    ...
    public static final TransactionType RESERVE_CLAIM = new MonetarySystem() {
        ...
        @Override
        public Attachment.MonetarySystemReserveClaim parseAttachment(ByteBuffer buffer) throws NxtException.NotValidException {
            return new Attachment.MonetarySystemReserveClaim(buffer);
        }

        @Override
        public Attachment.MonetarySystemReserveClaim parseAttachment(JSONObject attachmentData) throws NxtException.NotValidException {
    ...
    public static final TransactionType CURRENCY_TRANSFER = new MonetarySystem() {
        ...
        @Override
        public Attachment.MonetarySystemCurrencyTransfer parseAttachment(ByteBuffer buffer) throws NxtException.NotValidException {
            return new Attachment.MonetarySystemCurrencyTransfer(buffer);
        }

        @Override
        public Attachment.MonetarySystemCurrencyTransfer parseAttachment(JSONObject attachmentData) throws NxtException.NotValidException {
    ...
    public static final TransactionType PUBLISH_EXCHANGE_OFFER = new MonetarySystem() {
        ...
        @Override
        public Attachment.MonetarySystemPublishExchangeOffer parseAttachment(ByteBuffer buffer) throws NxtException.NotValidException {
            return new Attachment.MonetarySystemPublishExchangeOffer(buffer);
        }

        @Override
        public Attachment.MonetarySystemPublishExchangeOffer parseAttachment(JSONObject attachmentData) throws NxtException.NotValidException {
    ...
    public static final TransactionType EXCHANGE_BUY = new MonetarySystemExchange() {
        ...
        @Override
        public Attachment.MonetarySystemExchangeBuy parseAttachment(ByteBuffer buffer) throws NxtException.NotValidException {
            return new Attachment.MonetarySystemExchangeBuy(buffer);
        }

        @Override
        public Attachment.MonetarySystemExchangeBuy parseAttachment(JSONObject attachmentData) throws NxtException.NotValidException {
    ...
    public static final TransactionType EXCHANGE_SELL = new MonetarySystemExchange() {
        ...
        @Override
        public Attachment.MonetarySystemExchangeSell parseAttachment(ByteBuffer buffer) throws NxtException.NotValidException {
            return new Attachment.MonetarySystemExchangeSell(buffer);
        }

        @Override
        public Attachment.MonetarySystemExchangeSell parseAttachment(JSONObject attachmentData) throws NxtException.NotValidException {
    ...
    public static final TransactionType CURRENCY_MINTING = new MonetarySystem() {
        ...
        @Override
        public Attachment.MonetarySystemCurrencyMinting parseAttachment(ByteBuffer buffer) throws NxtException.NotValidException {
            return new Attachment.MonetarySystemCurrencyMinting(buffer);
        }

        @Override
        public Attachment.MonetarySystemCurrencyMinting parseAttachment(JSONObject attachmentData) throws NxtException.NotValidException {
    ...
    public static final TransactionType CURRENCY_DELETION = new MonetarySystem() {
        ...
        @Override
        public Attachment.MonetarySystemCurrencyDeletion parseAttachment(ByteBuffer buffer) throws NxtException.NotValidException {
            return new Attachment.MonetarySystemCurrencyDeletion(buffer);
        }

        @Override
        public Attachment.MonetarySystemCurrencyDeletion parseAttachment(JSONObject attachmentData) throws NxtException.NotValidException {
