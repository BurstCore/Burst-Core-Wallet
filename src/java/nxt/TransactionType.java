...
public abstract class TransactionType {
    ...
    abstract boolean applyUnconfirmed(TransactionImpl transaction, Account senderAccount);

    abstract boolean applyAttachmentUnconfirmed(Transaction transaction, Account senderAccount);

    abstract void apply(TransactionImpl transaction, Account senderAccount, Account recipientAccount);

    abstract void applyAttachment(Transaction transaction, Account senderAccount, Account recipientAccount);

    abstract void undoUnconfirmed(TransactionImpl transaction, Account senderAccount);
