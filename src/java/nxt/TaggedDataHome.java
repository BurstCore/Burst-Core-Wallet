...
public final class TaggedDataHome {
    ...
    void add(TransactionImpl transaction, Attachment.TaggedDataUpload attachment) {
    ...
    void extend(Transaction transaction, Attachment.TaggedDataExtend attachment) {
    ...
    void restore(Transaction transaction, Attachment.TaggedDataUpload attachment, int blockTimestamp, int height) {
