...
public final class TaggedDataHome {
    ...
    public void add(TransactionImpl transaction, Attachment.TaggedDataUpload attachment) {
    ...
    public void extend(Transaction transaction, Attachment.TaggedDataExtend attachment) {
    ...
    public void restore(Transaction transaction, Attachment.TaggedDataUpload attachment, int blockTimestamp, int height) {
