...
public final class PrunableMessageHome {
    ...
    public DbIterator<PrunableMessage> getAll(int from, int to) {
    ...
    public DbIterator<PrunableMessage> getPrunableMessages(long accountId, int from, int to) {
        Connection con = null;
        try {
            con = prunableMessageTable.getConnection();
    ...
    public DbIterator<PrunableMessage> getPrunableMessages(long accountId, long otherAccountId, int from, int to) {
        Connection con = null;
        try {
            con = prunableMessageTable.getConnection();
    ...
    public void add(TransactionImpl transaction, Appendix.PrunablePlainMessage appendix) {
        add(transaction, appendix, Nxt.getBlockchain().getLastBlockTimestamp(), Nxt.getBlockchain().getHeight());
    }

    public void add(TransactionImpl transaction, Appendix.PrunablePlainMessage appendix, int blockTimestamp, int height) {
    ...
    public void add(TransactionImpl transaction, Appendix.PrunableEncryptedMessage appendix) {
        add(transaction, appendix, Nxt.getBlockchain().getLastBlockTimestamp(), Nxt.getBlockchain().getHeight());
    }

    public void add(TransactionImpl transaction, Appendix.PrunableEncryptedMessage appendix, int blockTimestamp, int height) {
