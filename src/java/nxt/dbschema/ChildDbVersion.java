...
public class ChildDbVersion extends DbVersion {
    ...
    public ChildDbVersion(BasicDb db, String schema) {
        super(db, schema);
    }
        ...
        switch (nextUpdate) {
            case 1:
                apply("CREATE TABLE IF NOT EXISTS transaction (db_id IDENTITY, id BIGINT NOT NULL, "
                        ...
                        + "phased BOOLEAN NOT NULL DEFAULT FALSE, fxt_transaction_id BIGINT NOT NULL, "
            ...
            case 106:
                apply("CREATE INDEX IF NOT EXISTS tagged_data_id_height_idx ON tagged_data (id, height DESC)");
            case 107:
