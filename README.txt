...
Unpack the ardor-client.zip package and open a shell in the resulting ardor
...
The Ardor software is a client-server application. It consists of a java server
