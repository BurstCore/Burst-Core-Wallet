The Private Blockchain Evaluation Kit is a modified version of the Nxt
Reference Software (NRS), which does not use the public Nxt blockchain.
...
With this Private Blockchain Evaluation Kit, such users will now be able to
