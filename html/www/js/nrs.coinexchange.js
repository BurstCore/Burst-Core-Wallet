...
var NRS = (function (NRS, $, undefined) {
    ...
    function processOrders(orders, coinId, refresh) {
        ...
        if (orders.length) {
            ...
            for (var i = 0; i < orders.length; i++) {
                ...
                rows += "<tr data-transaction='" + NRS.escapeRespStr(order.order) + "' data-amount='" + String(order.exchangeQNT).escapeHTML() + "' data-price='" + String(order.askNQT).escapeHTML() + "'>" +
    ...
    buyCoinFields.keyup(function () {
        try {
            ...
            var priceNQTPerCoin = new BigInteger(NRS.convertToQNT(String($("#buy_coin_price").val()), currentCoin.decimals));
