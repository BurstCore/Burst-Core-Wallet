...
var NRS = (function (NRS, $, undefined) {
    ...
    NRS.processTransactionModalData = function (transaction, isModalVisible, sharedKey) {
        ...
        try {
            ...
            if (NRS.isOfType(transaction, "FxtPayment") || NRS.isOfType(transaction, "OrdinaryPayment")) {
                ...
                data.amount_formatted_html = NRS.formatQuantity(transaction.attachment.amountNQT, decimals);
    ...
    NRS.formatAssetOrder = function (asset, transaction, isModalVisible) {
        ...
        NRS.sendRequest("getOrderTrades", params, function (response) {
            ...
            data["total_traded"] = NRS.formatAmount(tradeTotal, false, true) + " " + NRS.getActiveChainName();
        }, { isAsync: false });
    ...
    NRS.formatCurrencyExchange = function (currency, transaction, type) {
        var rateUnitsStr = " [ " + currency.code + " / " + NRS.getActiveChainName() + " ]";
        var data = {
